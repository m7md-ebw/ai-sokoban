...
NOOP_PENALTY = 0.0           # bumping wall / no movement
DEADLOCK_PENALTY = 0.0       # pushing box into corner/3-wall pocket (not on goal)
MIN_BOX_GOAL_DIST = 2        # reject trivial rooms where |box-goal| (Manhattan) < this

# distance shaping (dense hints)
DIST_SHAPING_W = 0.02        # per-step *delta* weight; 0 disables
